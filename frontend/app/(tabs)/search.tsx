      ...
      <FlatList
        ...
        ListHeaderComponent={
          <>
            ...
            {featuredBooks.length > 0 && !searchQuery && selectedCategory === 'All' && (
              <View style={styles.featuredSection}>
                <Text style={[styles.featuredTitle, { color: colors.text }]}>Featured Books</Text>
                <FlatList
                  horizontal
                  data={featuredBooks}
            ...
            {!loading && results.length > 0 && (
              <Text style={[styles.resultsCount, { color: colors.textSecondary }]}>
                {results.length} {searchQuery ? `results for "${searchQuery}"` : 'books found'}
              </Text>
            )}
          </>
        }
