...
const GENRE_CONTEXT: Record<string, { heading: string; body: string }> = {
  ...
  Biography: {
    heading: 'About Classic Biography',
    body: `Biography is one of the oldest and most direct forms of literature — the attempt to render a human life with honesty, precision, and narrative shape. The great biographies and autobiographies of the literary tradition offer something that no other form can: direct access to the interior experience of people who shaped history, science, art, and thought. Autobiographical works like Benjamin Franklin's Autobiography, the Confessions of Jean-Jacques Rousseau, or Frederick Douglass's Narrative of the Life offer not just facts but the texture of a lived experience — how the world looked from inside a particular consciousness at a particular moment in history. Classic biographical writing also includes portraits of great figures by those who knew them well, and these accounts carry an immediacy and particularity that later histories often lack. Reading biography is to practice a form of empathy at scale: to inhabit, however temporarily, a life very different from one's own, and to understand from the inside what it meant to live, think, and act in another time and place.`,
  },
  "Children's Literature": {
    heading: "About Classic Children's Literature",
    body: `The greatest works written for children are not lesser literature — they are a distinct literary achievement, requiring unusual economy of language, imaginative vividness, and an ability to speak truthfully to readers who have not yet learned to accept the compromises that adults make with reality. The classics of children's literature in the public domain represent the founding works of the genre: Lewis Carroll's Alice's Adventures in Wonderland, which invented literary nonsense and remains one of the most philosophically rich books in the English language; J.M. Barrie's Peter Pan, which made the refusal to grow up into a genuine tragic theme; L. Frank Baum's The Wonderful Wizard of Oz, which created an entire American mythological landscape; and dozens of others that have shaped the imaginative lives of readers across generations. These books work on multiple levels simultaneously — they delight children with vivid characters and fast-moving plots while offering adults something richer and stranger on re-reading. That capacity to mean different things at different ages is the hallmark of the truly enduring work.`,
  },
  Romance: {
  ...
  Horror: {
    heading: 'About Classic Horror Literature',
    body: `Classic horror literature is concerned with what lies at the edges of human understanding — the forces, figures, and events that exceed rational explanation and produce genuine dread. The genre in its modern literary form was largely shaped in the 19th century, when writers began exploring the psychological dimensions of fear alongside its supernatural manifestations. Edgar Allan Poe invented the psychological horror story — tales in which the horror is as much internal as external, products of guilt, obsession, and the unreliable mind. Mary Shelley's Frankenstein posed questions about creation, responsibility, and the dangers of unchecked ambition that remain urgent today. Bram Stoker's Dracula assembled the conventions of the Gothic novel into their most enduring form, creating a figure that has never left the cultural imagination. Later writers — Sheridan Le Fanu, Arthur Machen, Algernon Blackwood — extended the tradition into territory that later became central to the genre. Classic horror is not merely entertainment: at its best, it is a form of literature that confronts the reader with genuine uncertainty about the nature of reality and the limits of human knowledge.`,
  },
  Poetry: {
